  ...
  return (
    <div className="my-6">
      ...
      <select
        ...
        className="p-2 rounded-md border-none text-base shadow appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
      >
        {tipos.map((t) => (
